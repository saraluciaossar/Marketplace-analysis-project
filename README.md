...
DatasetDescriptiontransactions.csvCore fact table — amount, date, card, company, user, productcompanies.csvSeller companies and their countriescredit_cards.csvCard identifiers and account detailsamerican_users.csv / european_users.csvUser demographics by regionproducts.csvProduct catalog
